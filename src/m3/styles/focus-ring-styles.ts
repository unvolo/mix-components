...
const FocusRingStyles = css`
  [part~='focus-ring'] {
    ...
    inset: calc(
        -1 * (var(--md-focus-ring-padding-vertical, 2px) +
              var(--md-focus-ring-inner-width, 2px) +
              var(--md-focus-ring-outer-width, 2px))
      )
      calc(
        -1 * (var(--md-focus-ring-padding-horizontal, 2px) +
              var(--md-focus-ring-inner-width, 2px) +
              var(--md-focus-ring-outer-width, 2px))
      );
  ...
  [part~='focus-ring']::before {
    ...
    position: absolute;
    inset: 0;
    border: var(--md-focus-ring-inner-width, 2px) solid
      var(--md-focus-ring-inner-color, var(--md-sys-color-tertiary));
    border-radius: calc(
      var(--md-focus-ring-radius, 8px) - var(--md-focus-ring-inner-width, 2px)
    );
  }
